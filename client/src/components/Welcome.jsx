...
const CommanStyles =
  "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white font-semibold text-gradient";
...
const Welcome = () => {
  ...
  return (
    <div className="flex w-full justify-center items-center -mt-9" id="Home">
